...
<section id="home-banner" style="background-image: url(img/b-1.jpg);">
  <div class="content">
    <div class="container"  data-wow-duration="1s"> <span class="wow fadeIn">Lambot 3478</span>
      <h1 class="wow fadeInUp">We are trying to make an efford to solve the impact of the COVID - 19 in our community. </h1>
    </div>
  </div>
...
<section id="home-contact-block">
  <div class="container">
    <div class="row wow fadeInUp">
      <p>Try to help us getting the data with a short test.</p>
      <a href="/test">Take the test</a> </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row"> 
      ...
      <div class="section-title text-center wow fadeInUp">
        <h2>Short cuts</h2>
        <a href="/recomendations">More news</a></div>
      <!--/section-title-->
      <div class="clearfix"></div>
      <div class="works">
        <ul class="grid">
          <li>
            <figure><img src="img/P1.jpg" alt="Screenshot 01">
              <figcaption>
                <div class="caption-content">
                  <h4>COVID - 19 search</h4>
                  <hr>
                  <h7>Information About</h7>
                  <ul class="work-more">
                    <li><a href="https://www.google.com/search?q=covid+19&oq=co&aqs=chrome.0.69i59l3j69i60l4.767j0j1&sourceid=chrome&ie=UTF-8" target="_Blank"><i class="fa fa-link"></i></a></li>
                  </ul>
                </div>
              </figcaption>
            </figure>
          ...
          <li>
            <figure><img src="img/P2.jpg" alt="Screenshot 01">
              <figcaption>
                <div class="caption-content">
                  <h4>About the COVID in Mexico</h4>
                  <hr>
                  <h7>All what you have to know</h7>
                  <ul class="work-more">
                    <li><a href="https://coronavirus.gob.mx/"target="_Blank"><i class="fa fa-search"></i></a></li>
                  </ul>
                </div>
              </figcaption>
            </figure>
          ...
          <li>
            <figure><img src="img/P3.jpg" alt="Screenshot 01">
              <figcaption>
                <div class="work-more">
                  <h4>Map with the results</h4>
                  <hr>
                  <h7>Where I am?</h7>
                  <ul class="work-more">
                    <li><a href="/map"><i class="fa fa-link"></i></a></li>
                  </ul>
                </div>
              </figcaption>
            </figure>
        ...
        <div class="tab-content"> 
          ...
          <div id="concept" class="tab-pane active"> 
            ...
            <div class="col-md-7 process-content">
              <h6>Simple questions, simple care</h6>
              <p>You can take a short test that will show you in real time your stadistics related to your answers, you can have acces to the main recomendations that will be based on your needs. You provide the data and we the information.</p>
              <a href="/test">Take the test</a> </div>
            <!--/tab content-->             
          </div>
          <!--/tab nav item 1--> 
          ...
          <div id="prototype" class="tab-pane"> 
            ...
            <div class="col-md-7 process-content">
              <h6>About numbers</h6>
              <p>At the end of the test, you are reciving the most important information related to your answers so you can take the necessary meassures</p>
              </div>
            <!--/tab content-->             
          </div>
          <!--/tab nav item 2--> 
          ...
          <div id="design" class="tab-pane"> 
            ...
            <!--tab content-->
            <div class="col-md-7 process-content">
              <h6>Location of information</h6>
              <p>For all the users we have created an easy way to see where are the main danger points so you can be prepared and choose the best options</p>
              <a href="/map">Check the map</a> </div>
            <!--/tab content-->             
          </div>
          <!--/tab nav item 3-->     
          ...
          <div id="development" class="tab-pane"> 
            <!--tab img-->
            <div class="col-md-5 process-img"> <img src="img/01-screenshot.png" class="img-responsive"> </div>
            <!--/tab img--> 
            <!--tab content-->
            <div class="col-md-7 process-content">
    ...
    <div class="row text-center">
      <div class="col-md-12 wow fadeInDown">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="c-block"><i class="fa fa-heart"></i><span class="counter">145</span>
            <p>Answers</p>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="c-block"><i class="fa fa-envelope-o"></i><span class="counter">567</span>
            <p>People</p>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="c-block"><i class="fa fa-folder-o"></i><span class="counter">8596</span>
            <p>Taked recomendations</p>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12">
